...
# 更多代码问题: 请点击文商科学码自救小组菜单栏"联系我们"，入群，让代码赋能工作
import pandas as pd
import pyperclip
import webbrowser
...
if __name__ == "__main__":
    ...
    mermaid_text = "graph TD\n"+gen_mermaid(df_holder = df_shareholder_structure,
                                                df_holding = df_shareholding_structure, issuer = "发行人公司名称")
    ...
    label_text = (
        ""
        "进入draw.io后，左上角"调整图形"→"插入"→"高级"→"Mermaid"，然后将剪贴板里的Mermaid代码文本粘贴进去\n"
